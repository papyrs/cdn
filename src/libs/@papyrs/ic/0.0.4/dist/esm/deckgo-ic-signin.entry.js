import { h, r as registerInstance, a as createEvent, H as Host } from './index-9daac24f.js';
import { m as signIn } from './auth.providers-48c2d466.js';
...
const icSigninCss = "deckgo-ic-signin div.actions{display:flex;justify-content:center;align-content:center;position:relative}deckgo-ic-signin p.terms{max-width:220px;margin-left:auto;margin-right:auto;text-align:center;font-size:var(--font-size-very-small, 10px);padding:calc(var(--padding, 16px) / 2) 0}deckgo-ic-signin div.spinner.hidden{display:none}";
...
const IcSignin = class {
  ...
  render() {
    return (h(Host, null, h("div", { class: "actions" }, this.renderSpinner(), this.renderAction()), this.renderTerms()));
  }
  renderSpinner() {
    return (h("div", { class: `spinner ${!this.signInInProgress ? 'hidden' : ''}` }, h("slot", { name: "spinner" })));
  }
  renderAction() {
    var _a;
...
export { IcSignin as deckgo_ic_signin };

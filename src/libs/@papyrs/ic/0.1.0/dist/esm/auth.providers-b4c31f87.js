import { E as EnvStore, e as delegationIdentityExpiration, h as createManagerActor } from './auth.constants-df89d2cd.js';
...
const workerPromise$1 = import('./idle.ic.worker-cad24e7d.js').then(m => m.worker);
...
const workerPromise = import('./user.ic.worker-7d410a65.js').then(m => m.worker);

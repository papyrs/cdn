import { c as consoleError } from './index-59f8abd3.js';
...
const workerPromise$1 = import('./idle.ic.worker-af10ff62.js').then(m => m.worker);
...
const workerPromise = import('./user.ic.worker-f2980dbe.js').then(m => m.worker);

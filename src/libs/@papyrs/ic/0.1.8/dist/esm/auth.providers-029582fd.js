import { E as EnvStore, h as delegationIdentityExpiration, c as createManagerActor } from './auth.constants-795d1603.js';
import { S as SignIdentity, g as global, A as AnonymousIdentity } from './actor-da64ce67.js';
import { E as Ed25519KeyIdentity, D as DelegationChain, i as isDelegationValid, b as DelegationIdentity, d as Delegation, e as del } from './compat-7469423b.js';
...
const workerPromise$1 = import('./idle.ic.worker-edc51b5b.js').then(m => m.worker);
...
const workerPromise = import('./user.ic.worker-87dab38e.js').then(m => m.worker);
...
const initAuth = async ({ config, success }) => {
  ...
  try {
    ...
    const $event = new CustomEvent('ddgInitUserError', {
      detail: err,
      bubbles: true
    });

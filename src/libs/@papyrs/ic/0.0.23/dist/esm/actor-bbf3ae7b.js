...
class Principal$1 {
    ...
    static from(other) {
        ...
        else if (Principal$1.isPrincipal(other)) {
            return new Principal$1(other.toUint8Array());
        }
    ...
    static isPrincipal(maybePrincipal) {
        if (maybePrincipal instanceof Principal$1)
            return true;
    ...
    static isPrincipalString(maybeValid) {
        if (typeof maybeValid === 'string') {
            try {
                Principal$1.fromText(maybeValid);
                return true;
            }
            catch (_) {
     ...
     */
    compareTo(other) {
        return Principal$1.compare(this, other);
    }
...
export { Actor as A, HttpAgent as H, Principal$1 as P, SignIdentity as S, commonjsRequire as a, commonjsGlobal as b, createCommonjsModule as c, global$1 as d, AnonymousIdentity as e, getAugmentedNamespace as g, requestIdOf as r, src as s };

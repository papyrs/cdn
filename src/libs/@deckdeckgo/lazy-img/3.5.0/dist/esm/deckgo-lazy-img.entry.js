import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from './index-0117e929.js';
...
const DeckdeckgoLazyImg = class {
  ...
  renderImage() {
    // prettier-ignore
    // @ts-ignore
    return h("img", { alt: this.imgLoaded ? (this.imgAlt ? this.imgAlt : this.imgSrc) : '', loading: this.loading, sizes: this.imgSizes ? this.imgSizes : undefined, intrinsicsize: this.intrinsicsize, width: this.imgWidth, height: this.imgHeight, part: "img", onLoad: () => this.onImgDidLoad(), onError: () => this.loadError() });
  }
...
DeckdeckgoLazyImg.style = deckdeckgoLazyImgCss;

export { DeckdeckgoLazyImg as deckgo_lazy_img };

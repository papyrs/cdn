...
import { a as DeckdeckgoHighlightCodeCarbonTheme, D as DeckdeckgoHighlightCodeTerminal, d as deckdeckgoHighlightCodeLanguages } from './languages.js';
...
let HighlightCode = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
HighlightCode = /*@__PURE__*/ proxyCustomElement(HighlightCode, [1, "deckgo-highlight-code", {
    "language": [513],
...
export { DeckgoHighlightCode, defineCustomElement };
